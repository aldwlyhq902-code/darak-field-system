    ...
    return Card(
      child: ListTile(
        ...
        onTap: () => Navigator.of(context).push(
          MaterialPageRoute(
            builder: (_) =>
                VisitScreen(state: state, visitId: visit['id'] as int),
          ),
        ),
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                _Chip(
                  label: _stateLabel(visit['state'] as String?),
                ...
                if (isRework)
                  const _Chip(label: 'إعادة زيارة', color: Colors.red),
              ],
            ),
          ],
        ),
